...
export const getAllSoftwareApplications = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      `${import.meta.env.VITE_APP_URL}/api/v1/softwareapplication/getall`,
...
export const addNewSoftwareApplication = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      `${import.meta.env.VITE_APP_URL}/api/v1/softwareapplication/add`,
      data,
      {
        withCredentials: true,
...
export const deleteSoftwareApplication = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `${import.meta.env.VITE_APP_URL}/api/v1/softwareapplication/delete/${id}`,
      {
        withCredentials: true,
      }
    );
